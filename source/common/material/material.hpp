...
namespace our
{
    ...
    // - vec3 Tints
    //  - "albedo_tint", "specular_tint", "emissive_tint"(optional)
    // An example where this material can be used is when the object has a texture and lit
    ...
    inline Material *createMaterialFromType(const std::string &type)
    {
        ...
        {
            return new TexturedLitMaterial();
        }
        else
        {
            return new Material();
